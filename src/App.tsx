      ...
      <main className="main">
		<section className="first-section">
				<h1 className="fi-section-title main-title">Designed for the future</h1>
  				...
  				<img className="fi-section-illustration" src="/BlogrLandingPage/assets/illustration-editor-desktop.svg" alt="Illustration Editor"></img>
		...
		<img className="se-section-illustration" src="/BlogrLandingPage/assets/illustration-phones.svg" alt=""></img>
			
		<section className="second-section">
			<div className="se-section-illustration-desktop-wrapper">
				<img className="se-section-illustration-desktop" src="/BlogrLandingPage/assets/illustration-phones.svg" alt=""></img>
			</div>

			<div className="se-title-paragraph">
				<img className="se-section-illustration-pattern" src="/BlogrLandingPage/assets/bg-pattern-circles.svg" alt=""></img>
		...
		<section className="third-section">
			...
			<img className="th-section-illustration"src="/BlogrLandingPage/assets/illustration-laptop-desktop.svg" alt=""></img>
